...
# BUG Comments have to be on top because gdformatter ignores it and tries to place in single line
# Ignore line doesn't work for some reason, https://github.com/GDQuest/GDScript-formatter/issues/192 does ask for a rule to ignore the whole file
enum StackMode {
	# Cannot stack, application is ignored if present
	NONE,
	# Adds a new stack (up to max_stacks), keeps duration
	STACK,
